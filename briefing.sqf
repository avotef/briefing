...
*/
	...
	player createDiaryRecord ["ozzyfeatures",
		[
			"Treasure Wrecks",
				"
				In the indicated gold zones throughout the ocean you can find a crashed plane wreck on the ocean floor.<br/>
				<br/>
				If you find one it will be filled with an infinite supply of gold you can plunder and sell at the Treasure Dealer.<br/>
				This may take some patience to find as you will be required to completely sweep the ocean floor.<br/><br/>
				NOTE: There are safe guards in place that will prevent the rendering of the wreck whilst you are still on the surface. This is to prevent players from cheating by using the ARMA water surface glitch to locate it.<br/>
	...
	player createDiaryRecord ["ozzyfeatures",
		[
			"SDV Features",
				"
				Whilst In an SDV there is an built in Depth Sonar that appears under your phone battery icon on your HUD.<br/><br/>
				Also a rebreather is not essential when diving whilst in an SDV. Goggles though are still recommended.
				"
		]
	];
	...
	player createDiaryRecord ["ozzyfeatures",
		[
			"Truck Delivery Missions",
				"
				At every Freight Yard there is Truck Delivery missions that can be undertaken that can be quite profitable.<br/><br/>
				Simply select whether you would like to do a legal or illegal mission. The truck will appear but be warned if you choose the illegal mission the police will be alerted to your activity.
				"
		]
	];
	...
	player createDiaryRecord ["ozzyfeatures",
		[
			"Vehicle Loading",
				"
				Some Vehicles can carry other vehicles. For Example Trucks can carry some smaller vehicles and big trucks can carry more aswell as SDV's or cars. CH-49 Mohawks are preferred among some because they are fast and they can carry quite a lot.
				"
		]
	];
	...
	player createDiaryRecord ["ozzyfeatures",
		[
			"Reserve Robbing",
				"
				Insurance is now a thing of the past. Gold is the future. To steal from the reserve you require Bolt Cutter and Blasting Charge. Once you get into the Vault you can steal the gold by putting it in your vehicle and selling it at a dealer.
				"
		]
	];
	...
	player createDiaryRecord ["ozzyfeatures",
		[
			"Stealing Organs",
				"
				Rebel is always fun. But now its better. Steal the organs of your victims and sell them at the dealer for an extra profit. This requires Zip Ties.
				"
		]
	];
	...
	player createDiaryRecord ["serverinfo",
		[
			"TeamSpeak Address",
				"
				tssyd1.vilayer.com:10007<br/><br/>
				"
		]
	];
	...
	player createDiaryRecord["changelog",
		[
			"Official Change Log",
				"
					The official change log can be found on the BIS forums (search Altis Life RPG)<br/><br/>
				"
		]
	];
	...
	player createDiaryRecord["changelog",
		[
			"Custom Change Log",
				"
					A persistant Y-menu hold 1000 weight has been added to houses equiped with storage boxes<br/><br/>
					This is in addition to the weapon inventory, and item crate already available with housing<br/><br/>
					Added Holstering of handguns<br/><br/>
				"
		]
	];
		...
		[
			"Safe Zones",
				"
					...
					Rebel Outposts<br/>
					Donator Shops<br/><br/>
					AND the surrounding 20 Minutes of all the areas listed above.<br/><br/>
				"
		]
	];
	...
	player createDiaryRecord ["serverrules",
		[
			"New Life Rule", 
				...
				Items on this list may result in your removal from the server and/or ban, based on the admins discretion.<br/><br/>
				1. If you are killed you cannot rejoin the engagement that you were killed in.<br/>
				1a. Police can rejoin the engagement after 15 minutes after they were killed. BUT NOT BEFORE.<br/>
				2. If you are killed you must wait 15 minutes before returning to the scene of your death.<br/>
				3. If you die during roleplay your past crimes are forgotten, but you also cannot seek revenge.<br/>
				4. If you are RDM'd, it is not a new life.<br/>
				5. If you manually respawn, it is not a new life.<br/>
				6. If you purposefully kill yourself to avoid roleplay, it is not a new life.<br/><br/>
				"
		]
	];
	...
	player createDiaryRecord ["serverrules",
		[
			"Don't Be A Dick!", 
				...
				DO NOT BUY A HOUSE WITH A MERCHANT IN IT!<br/>
				Roleplay, this ain't Call of Duty.<br/><br/>
				Picking up a duped item will get you temp banned from server, and yes we have logs!<br/><br/>
				"
		]
	];
...
// Police Section
	...
	player createDiaryRecord ["policerules",
		[
			"Teamspeak Rule",
				"
				1. All cops must be on Teamspeak in a designated cop channel. Failure to be on comms during an admin check can get you booted from the cops<br/>
	...
	player createDiaryRecord ["illegalitems",
		[
			"Illegal Vehicles",
				...
				4. Police Offroad<br/>
				5. Strider<br/>
				6. All rebel skinned vehicles<br/>
				"
		]
	];
	player createDiaryRecord ["illegalitems",
		[
			"Illegal Weapons",
				...
				10. Any other rifle over 5.56mm, not listed<br/><br/>
				11. Vermin or any other SMG other than a PDW<br/><br/>
				"
		]
	];
	player createDiaryRecord ["illegalitems",
	...
	player createDiaryRecord ["controls",
		[
			"",
				...
				U: Lock and unlocks (Cars, Houses)<br/>
				F: Cop Siren (if cop)<br/>
				T: Vehicle and House Trunk<br/>
				K: EMP Console equiped to the Police Hummingbird (Cop Only)<br/>
				...
				Left Shift + B: Restrain (Civilian Zipties)
				Left Shift + G: Surrender, and put your hands on the back of your head<br/>
				...
				Left Shift + H: Holsters a handgun, IT WILL NOT BE SAVED WHILE HOLSTERED!<br/>
				Left CTRL + H: UnHolsters a handgun, IT WILL NOT BE SAVED WHILE HOLSTERED!<br/>
